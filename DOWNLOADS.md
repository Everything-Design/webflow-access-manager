...
> **Latest release: [v2.3.0](https://github.com/Everything-Design/webflow-access-manager/releases/tag/v2.3.0)**
...
- **Apple Silicon (M1/M2/M3/M4)** — [Download arm64 .dmg (124 MB)](https://github.com/Everything-Design/webflow-access-manager/releases/download/v2.3.0/Webflow.Access.Manager.2.3.0.arm64.dmg)
- **Intel Mac** — [Download x64 .dmg (129 MB)](https://github.com/Everything-Design/webflow-access-manager/releases/download/v2.3.0/Webflow.Access.Manager.2.3.0.x64.dmg)
...
- **Installer (recommended)** — [Download Setup .exe (104 MB)](https://github.com/Everything-Design/webflow-access-manager/releases/download/v2.3.0/Webflow.Access.Manager.Setup.2.3.0.exe)
- **Portable** — [Download Portable .exe (104 MB)](https://github.com/Everything-Design/webflow-access-manager/releases/download/v2.3.0/Webflow.Access.Manager.2.3.0.Portable.exe) — no install, run from anywhere
